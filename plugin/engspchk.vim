...
" ---------------------------------------------------------------------
 ...
 " Pre-Loading Plugin menu support:
...
"       call Decho("lang<".lang."> dictfile<".dictfile."> dictfiles<".dictfiles.">")
       ...
       if lang != b:spchklang && a:domenu == 2
        ...
        exe 'menu '.g:PluginTopLvlMenu.'Load\ AltLang\ Spelling\ Checker.Load\ As\ '.Lang.'spchk :call <SID>SpchkAltLang("'.lang.'")'."<cr>"
       endif
"	   call Decho('setting up '.Lang.'spchk command')
	 ...
	 exe 'silent! unmenu '.g:PluginTopLvlMenu.'Load\ AltLang\ Spelling\ Checker'
	endif
...
"    call Dret("SpchkVisBlock")
  ...
  " ---------------------------------------------------------------------
  " set up PluginTopLevelMenu {{{2
 if exists("did_install_default_menus") && has("menu") && has("gui_running") && &go =~ 'm'
  if !exists("g:PluginTopLvlMenu") || g:PluginTopLvlMenu == ""
   let g:PluginTopLvlMenu= "Plugin."
  endif
  exe 'menu '.g:PluginTopLvlMenu.'Load\ Spelling\ Checker<tab>'.s:mapleadstring.'ec	<Leader>ec'
...
"   call Decho("curopt<".curopt.">")
   if curopt == "b:spchkacronym" || curopt == "b:spchkaltright" || curopt == "b:spchkautonext" || curopt == "b:spchkcvimsyn" || curopt == "b:spchkdialect" || curopt == "b:spchkPluginTopLvlMenu" || curopt == "b:spchklang" || curopt == "b:spchkmouse" || curopt == "b:spchknonhl" || curopt == "b:spchkproj" || curopt == "b:spchkpunc" || curopt == "b:spchksilent"
...
call s:SpchkSetCvimsyn()
let b:cvimsyn          = escape(g:cvimsyn,' ')
let b:PluginTopLvlMenu = exists("g:PluginTopLvlMenu")? g:PluginTopLvlMenu : ""
...
if exists("did_install_default_menus") && has("menu") && has("gui_running") && &go =~ 'm'
 " remove \ec from Plugin menu
 exe 'silent! unmenu '.b:PluginTopLvlMenu.'Load\ Spelling\ Checker'
...
" Plugin Menu {{{2
if exists("did_install_default_menus") && has("menu") && has("gui_running") && &go =~ 'm'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Alternative\ spellings<tab>'.s:mapleadstring.'ea		'.s:usermaplead.'ea'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Move\ to\ next\ spelling\ error<tab>'.s:mapleadstring.'en	'.s:usermaplead.'en'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Move\ to\ previous\ spelling\ error<tab>'.s:mapleadstring.'ep	'.s:usermaplead.'ep'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ user\ dictionary\ (temporarily)<tab>'.s:mapleadstring.'et	'.s:usermaplead.'et'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ user\ dictionary\ (permanently)<tab>'.s:mapleadstring.'es	'.s:usermaplead.'es'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ proj\ dictionary\ (permanently)<tab>'.s:mapleadstring.'ej	'.s:usermaplead.'ej'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ user\ dictionary\ (temporarily)<tab>'.s:mapleadstring.'eT	'.s:usermaplead.'eT'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ user\ dictionary\ (permanently)<tab>'.s:mapleadstring.'eS	'.s:usermaplead.'eS'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ proj\ dictionary\ (permanently)<tab>'.s:mapleadstring.'eJ	'.s:usermaplead.'eJ'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Dialect:\ toggle\ Warning/Error\ highlighting<tab>'.s:mapleadstring.'ed	'.s:usermaplead.'ed'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.RareWord:\ toggle\ Warning/Error\ highlighting<tab>'.s:mapleadstring.'er	'.s:usermaplead.'er'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Load\ '.b:Spchklang.'spchk<tab>'.s:mapleadstring.'ec		'.s:usermaplead.'ec'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.End\ '.b:Spchklang.'spchk<tab>'.s:mapleadstring.'ee		'.s:usermaplead.'ee'
 exe 'menu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Help<tab>\ 		:help engspchk<cr>'
...
"   	call Decho("remove menu entries")
    exe 'menu '.b:PluginTopLvlMenu.'Load\ Spelling\ Checker<tab>'.s:mapleadstring.'ec	<Leader>ec'

    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Alternative\ spellings<tab>'.s:mapleadstring.'ea		'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Move\ to\ next\ spelling\ error<tab>'.s:mapleadstring.'en	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Move\ to\ previous\ spelling\ error<tab>'.s:mapleadstring.'ep	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ user\ dictionary\ (temporarily)<tab>'.s:mapleadstring.'et	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ user\ dictionary\ (permanently)<tab>'.s:mapleadstring.'es	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Save\ word\ to\ proj\ dictionary\ (permanently)<tab>'.s:mapleadstring.'ej	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ user\ dictionary\ (temporarily)<tab>'.s:mapleadstring.'eT	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ user\ dictionary\ (permanently)<tab>'.s:mapleadstring.'eS	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Remove\ word\ from\ proj\ dictionary\ (permanently)<tab>'.s:mapleadstring.'eJ	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Dialect:\ toggle\ Warning/Error\ highlighting<tab>'.s:mapleadstring.'ed	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.RareWord:\ toggle\ Warning/Error\ highlighting<tab>'.s:mapleadstring.'er	'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Load\ '.b:Spchklang.'spchk<tab>'.s:mapleadstring.'ec		'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.End\ '.b:Spchklang.'spchk<tab>'.s:mapleadstring.'ee		'
    exe 'silent! unmenu '.b:PluginTopLvlMenu.b:Spchklang.'spchk.Help<tab>\ '
	call s:AltLangMenus(1)
...
syn keyword spchkMLoption contained PluginTopLvlMenu      altright      dialect       nonhl      silent      proj
syn keyword spchkMLoption contained spchkcvimsyn          spchkacronym  spchkautonext spchkmouse spchkpunc   spchklang
syn keyword spchkMLoption contained spchkPluginTopLvlMenu spchkaltright spchkdialect  spchknonhl spchksilent spchkproj
