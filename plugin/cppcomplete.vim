...
if has("gui_running") || s:useWildMenu
	...
	silent! aunmenu &Plugin.&cppcomplete
	silent! tunmenu &Plugin.&cppcomplete
	amenu &Plugin.&cppcomplete.&GenerateTags.&Rebuild\ from\ current\ directory<Tab>:GenerateTags   :GenerateTags<CR>
	tmenu &Plugin.&cppcomplete.&GenerateTags.&Rebuild\ from\ current\ directory Generate a new cppcomplete.tags file from the files in the current dorectory
	amenu &Plugin.&cppcomplete.&GenerateTags.&Append\ from\ current\ directory<Tab>:GenerateAndAppend   :GenerateAndAppend<CR>
	tmenu &Plugin.&cppcomplete.&GenerateTags.&Append\ from\ current\ directory Append instead of creating a totally new one.
	amenu &Plugin.&cppcomplete.&GenerateTags.&Browse\ file\ to\ append<Tab>:BrowseNFiles   :BrowseNFiles<CR>
	tmenu &Plugin.&cppcomplete.&GenerateTags.&Browse\ file\ to\ append Append a file using the file browser.
	amenu &Plugin.&cppcomplete.&GenerateTags.A&uto\ Generate\ a\ new\ one<Tab>:GenerateFromCheckpath   :GenerateFromCheckpath<CR>
	tmenu &Plugin.&cppcomplete.&GenerateTags.A&uto\ Generate\ a\ new\ one Auto generate a new cppcomplete.tags file for C/C++.
	amenu &Plugin.&cppcomplete.&GenerateTags.Aut&o\ Generate\ and\ append<Tab>:AppendFromCheckpath   :AppendFromCheckpath<CR>
	tmenu &Plugin.&cppcomplete.&GenerateTags.Aut&o\ Generate\ and\ append Auto generate and append.
	amenu &Plugin.&cppcomplete.&Use\ generated\ tag\ file\ in\ tags.&No<TAB>:ClearFromTags   :ClearFromTags<CR>
	tmenu &Plugin.&cppcomplete.&Use\ generated\ tag\ file\ in\ tags.&No Do not use cppcomplete.tags as an ordinary tag file
	amenu &Plugin.&cppcomplete.&Use\ generated\ tag\ file\ in\ tags.&Yes<Tab>:InsertToTags   :InsertToTags<CR>
	tmenu &Plugin.&cppcomplete.&Use\ generated\ tag\ file\ in\ tags.&Yes Use cppcomplete.tags as an ordinary tag file
	amenu &Plugin.&cppcomplete.-SEP1-   <NOP>
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Typedefs<Tab>:ToggleTDefs   :ToggleTDefs<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Typedefs Toggle search for typedefs
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Macros<Tab>:ToggleMacros   :ToggleMacros<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Macros Toggle search for macros
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Access\ check<Tab>:ToggleAccess  :ToggleAccess<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Access\ check Should only  items with the proper access be displayed?
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Relaxed\ ancestor\ check<Tab>:ToggleRelaxed   :ToggleRelaxed<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Relaxed\ ancestor\ check Allow inner classes that may be wrong but hard to check?
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.Global\ &variables<Tab>:ToggleGlobalVars  :ToggleGlobalVars<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.Global\ &variables Search cppcomplete.tags for global variables?
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Classes\ as\ class\ members<Tab>:ToggleClassMembers  :ToggleClassMembers<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.&Classes\ as\ class\ members Complete classes that is members of other classes?
	amenu &Plugin.&cppcomplete.&Toggle\ search\ options.Inner\ class\ &names\ in\ tags<Tab>:ToggleClassTags  :ToggleClassTags<CR>
	tmenu &Plugin.&cppcomplete.&Toggle\ search\ options.Inner\ class\ &names\ in\ tags Search cppcomplete.tags for classes that is defined in other classes scope?
	amenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Show\ access<Tab>:ToggleShowAccess  :ToggleShowAccess<CR>
	tmenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Show\ access Should the popup menu also display access information?
	amenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Inheritance\ for\ ::<Tab>:ToggleInheritance  :ToggleInheritance<CR>
	tmenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Inheritance\ for\ :: Should :: also show inherited items?
	amenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Nanny\ mode<Tab>:ToggleNanny  :ToggleNanny<CR>
	tmenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Nanny\ mode Try to give some extra help.
	amenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Fast\ grep<Tab>:ToggleFastGrep  :ToggleFastGrep<CR>
	tmenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Fast\ grep --mmap option for GNU grep
	amenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Preview<Tab>:TogglePreview   :TogglePreview<CR>
	tmenu &Plugin.&cppcomplete.Toggle\ &misc\ options.&Preview Open a preview window after completion?
	amenu &Plugin.&cppcomplete.-SEP2-   <NOP>
	amenu &Plugin.&cppcomplete.&Preview\ menu.Scan\ for\ new\ &items<Tab>:RefreshMenu   :RefreshMenu<CR>
	tmenu &Plugin.&cppcomplete.&Preview\ menu.Scan\ for\ new\ &items Scan cppcomplete.tags for classes, structures and unions
	amenu &Plugin.&cppcomplete.&Preview\ menu.&Classes.*****\ \ \ Nothing\ yet\ \ \ *****   <NOP>
	amenu &Plugin.&cppcomplete.&Preview\ menu.&Structures.*****\ \ \ Nothing\ yet\ \ \ ******   <NOP>
	amenu &Plugin.&cppcomplete.&Preview\ menu.&Unions.*****\ \ \ Nothing\ yet\ \ \ *****   <NOP>
	amenu &Plugin.&cppcomplete.&Block\ menu.&Build\ Menu\ From\ Block<Tab>:BuildMenuFromBlock   :BuildMenuFromBlock<CR>
	tmenu &Plugin.&cppcomplete.&Block\ menu.&Build\ Menu\ From\ Block Build a menu from the items in the current block.
	amenu &Plugin.&cppcomplete.-SEP3-   <NOP>
	amenu &Plugin.&cppcomplete.S&et\ C/C++\ or\ Java<Tab>:SetLanguage   :SetLanguage<CR>
	tmenu &Plugin.&cppcomplete.S&et\ C/C++\ or\ Java Set the current language used.
	amenu &Plugin.&cppcomplete.Set\ max\ number\ of\ &hits\ displayed<Tab>:SetMaxHits   :SetMaxHits<CR>
	tmenu &Plugin.&cppcomplete.Set\ max\ number\ of\ &hits\ displayed How many items should the popup menu have?
	amenu &Plugin.&cppcomplete.&Show\ current\ settings<Tab>ShowCurrentSettings   :ShowCurrentSettings<CR>
	tmenu &Plugin.&cppcomplete.&Show\ current\ settings List the current settings.
	amenu &Plugin.&cppcomplete.-SEP4-   <NOP>
	amenu &Plugin.&cppcomplete.&RestorePopUp<Tab>:RestorePopup :RestorePopup<CR>
	tmenu &Plugin.&cppcomplete.&RestorePopUp Restores the popup menu.
endif
...
function! s:RefreshMenu()	
	...
	while match(items,"\t",nextM)>0
		...
		if (mc>=0) && (mc<nextM)
			let cf=1
			execute "amenu .200 &Plugin.&cppcomplete.&Preview.&Classes." . cMore . @c . " :PreviewEntry " . @c ."<CR>" 
		...
		elseif (ms>=0) && (ms<nextM)
			let sf=1
			execute "amenu .300 &Plugin.&cppcomplete.&Preview.&Structures." . sMore . @c . " :PreviewEntry " . @c ."<CR>"
			...
			let uf=1
			execute "amenu .400 &Plugin.&cppcomplete.&Preview.&Unions." . uMore . @c . " :PreviewEntry " . @c ."<CR>"
	...
	endwhile
	if cf==0
		amenu &Plugin.&cppcomplete.&Preview.&Classes.*****\ \ \ no\ classes\ found\ \ \ ***** <NOP>
	endif
	if sf==0
		amenu &Plugin.&cppcomplete.&Preview.&Structures.*****\ \ \ no\ structures\ found\ \ \ ***** <NOP>
	endif
	if uf==0
		amenu &Plugin.&cppcomplete.&Preview.&Unions.*****\ \ \ no\ unions\ found\ \ \ ***** <NOP>
	endif
endfunction
...
function! s:BuildMenuFromBlock()
	...
	while match(s:regexBlock, "\t", nextM)>0
		...
		if match(hittedList, "\n" . group . @c . "\n")<0
			...
			execute "amenu &Plugin.&cppcomplete.&Block\\ menu.menu\\ built\\ from\\ regexp." . bMore . group . @c . " :JumpToLineInBlock " . nLines . "<CR>"
		else
