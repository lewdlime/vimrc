...
"------------------------------------------------------------------------------
" Tip: 
" You can change your rulerformat to display the name of color scheme in 
" your [._]vimrc 
"
...
"
" GetColorSyntaxName() function is defined in this script 
"------------------------------------------------------------------------------
...
if !exists("g:change_color_scheme")
    ...
    function! SetGuiFont()
        ...
        " and it looks good. You can download font from 
...
" is 1 bigger than number of sep character
