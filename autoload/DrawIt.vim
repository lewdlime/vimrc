...
"   call Dret("DrawItStart")
 ...
 if has("gui_running") && has("menu") && &go =~# 'm'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Stop\ \ DrawIt<tab>\\ds				<Leader>ds'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Toggle\ Erase\ Mode<tab><space>	<space>'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Arrow<tab>\\a					<Leader>a'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Box<tab>\\b						<Leader>b'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Make\ Blank\ Zone<tab>\\c			<Leader>c'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Ellipse<tab>\\e					<Leader>e'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Flood<tab>\\e					<Leader>f'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Line<tab>\\l						<Leader>l'
  exe 'menu '.g:PluginTopLvlMenu.'DrawIt.Append\ Blanks<tab>\\s				<Leader>s'
  exe 'silent! unmenu '.g:PluginTopLvlMenu.'DrawIt.Start\ DrawIt'
 endif
" call Dret("DrawItStart")
endfun
...
"   call Dret("DrawItStop")
 ...
 " DrawItStop: Plugin menu support: {{{3
 if has("gui_running") && has("menu") && &go =~# 'm'
  exe 'menu   '.g:PluginTopLvlMenu.'DrawIt.Start\ DrawIt<tab>\\di		<Leader>di'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Stop\ \ DrawIt'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Toggle\ Erase\ Mode'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Arrow'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Box'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Ellipse'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Flood'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Draw\ Line'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Make\ Blank\ Zone'
  exe 'unmenu '.g:PluginTopLvlMenu.'DrawIt.Append\ Blanks'
 endif
" call Dret("DrawItStop")
endfun
