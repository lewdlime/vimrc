...
"   call Decho("disable AnsiEsc highlighting: s:AnsiEsc_ft_".bn."<".s:AnsiEsc_ft_{bn}."> bn#".bn)
   ...
   if has("gui_running") && has("menu") && &go =~ 'm'
    " menu support
    exe 'silent! unmenu '.g:PluginTopLvlMenu.'AnsiEsc'
    exe 'menu '.g:PluginTopLvlMenu.'AnsiEsc.Start<tab>:AnsiEsc		:AnsiEsc<cr>'
   endif
...
"   call Decho("enable AnsiEsc highlighting: s:AnsiEsc_ft_".bn."<".s:AnsiEsc_ft_{bn}."> bn#".bn)
   if has("gui_running") && has("menu") && &go =~ 'm'
    " menu support
    exe 'silent! unmenu '.g:PluginTopLvlMenu.'AnsiEsc'
    exe 'menu '.g:PluginTopLvlMenu.'AnsiEsc.Stop<tab>:AnsiEsc		:AnsiEsc<cr>'
   endif
